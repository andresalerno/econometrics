...
Conforme dito, iremos estimar o modelo econométrico acima mas com algumas modificações: sem o fator `treinamento` e com transformação logaritmica na variável `salario`. Com estes ajustes, comuns em exercícios empíricos, chegamos a uma especificação como esta:
...
Para saber mais e se aprofundar no assunto, [confira os cursos aplicados de R e Python da Análise Macro](https://analisemacro.com.br/treinamento/cursos-aplicados-de-r-e-python-turmas-de-outono/) disponíveis neste outono. Além disso, existem alguns materiais gratuitos sobre modelos disponíveis no blog:
